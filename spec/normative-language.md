...
<!-- Provenance: adapted from the MNCS `spec/normative-language.md` wording so
MNCDS specifications do not depend on an MNCS checkout to interpret RFC 2119
terms. -->

The terms in this document have these MNCDS 0.1 meanings when capitalized:
